...
with open('updated_data_2.csv', mode ='r')as file:
...
age = age[1:]
sleepDur = sleepDur[1:]
sleepQuality = sleepQuality[1:]
stressLevel = stressLevel[1:]
job_list = job_list[1:]
physicalAct = physicalAct[1:]
...
# with open('data_1_systolic.txt', mode = 'w') as file:
#     file.write('systolic'+'\n')
#     for var in systolic:
#         file.write(str(var)+'\n')

# print("Correlation between stressLevel and sleepQuality")


# my_spearman = spearman_with_ties(stressLevel, sleepQuality)
# builtInSpearman, sp_p_value = stats.spearmanr(stressLevel, sleepQuality)

# my_pearson = pearson(stressLevel, sleepQuality)
# builtInPearson, p_p_value = stats.pearsonr(stressLevel, sleepQuality)


# print(f"My Spearman/built-in Spearman: {my_spearman}")
# print(f"My Pearson/built-in Pearson: {my_pearson}\n")

# print("Correlation between stressLevel and Job Occupation")


# my_spearman = spearman_with_ties(stressLevel, job_list)
# builtInSpearman, sp_p_value = stats.spearmanr(stressLevel, job_list)

# my_pearson = pearson(stressLevel, job_list)
# builtInPearson, p_p_value = stats.pearsonr(stressLevel, job_list)


# print(f"My Spearman/built-in Spearman: {my_spearman}")
# print(f"My Pearson/built-in Pearson: {my_pearson}\n")

# print("Correlation between Sleep Quality and Job Occupation")


# my_spearman = spearman_with_ties(sleepQuality, job_list)
# builtInSpearman, sp_p_value = stats.spearmanr(sleepQuality, job_list)

# my_pearson = pearson(sleepQuality, job_list)
# builtInPearson, p_p_value = stats.pearsonr(sleepQuality, job_list)


# print(f"My Spearman/built-in Spearman: {my_spearman}")
# print(f"My Pearson/built-in Pearson: {my_pearson}\n")

# print("Correlation between Age and Sleep Quality")


# my_spearman = spearman_with_ties(sleepQuality, age)
# builtInSpearman, sp_p_value = stats.spearmanr(sleepQuality, age)

# my_pearson = pearson(sleepQuality, age)
# builtInPearson, p_p_value = stats.pearsonr(sleepQuality, age)
...
# print("Correlation between Physical Activity and Sleep Quality")


# my_spearman = spearman_with_ties(sleepQuality, physicalAct)
# builtInSpearman, sp_p_value = stats.spearmanr(sleepQuality, physicalAct)

# my_pearson = pearson(sleepQuality, physicalAct)
# builtInPearson, p_p_value = stats.pearsonr(sleepQuality, physicalAct)


# print(f"My Spearman/built-in Spearman: {my_spearman}")
# print(f"My Pearson/built-in Pearson: {my_pearson}\n")

# print("Correlation between Sleep Duration and Sleep Quality")


# my_spearman = spearman_with_ties(sleepQuality, sleepDur)
# builtInSpearman, sp_p_value = stats.spearmanr(sleepQuality, sleepDur)

# my_pearson = pearson(sleepQuality, sleepDur)
# builtInPearson, p_p_value = stats.pearsonr(sleepQuality, sleepDur)


# print(f"My Spearman/built-in Spearman: {my_spearman}")
# print(f"My Pearson/built-in Pearson: {my_pearson}\n")

# print("Correlation between Sleep Duration and Stress Level")


# my_spearman = spearman_with_ties(stressLevel, sleepDur)
# builtInSpearman, sp_p_value = stats.spearmanr(stressLevel, sleepDur)

# my_pearson = pearson(stressLevel, sleepDur)
# builtInPearson, p_p_value = stats.pearsonr(stressLevel, sleepDur)
...
plot_regres_feature(X, y)

plot_polyreg_SVR(X, y)
feature_names = ['job_activity', 'sleep_duration', 'Sleep Quality', 'physical_activity', 'age']
# plot_svr_scatter_with_lines(X, y, feature_names, kernel='rbf', C=1.0)

plot_spline_importance(X, y, feature_names)
# plot_spline_with_lines(X, y, feature_names)
